...
CJNIEXPORT jobject JNICALL Java_rharriso_tonetimer_TimerViewModel_createWithView(JNIEnv* jniEnv, jobject /*this*/, jobject j_view)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
        auto r = ::tonetimer::TimerViewModel::createWithView(::djinni_generated::NativeTimerView::toCpp(jniEnv, j_view));
